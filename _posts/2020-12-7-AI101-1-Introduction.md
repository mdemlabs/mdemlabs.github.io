...
Bu sorunun cevabı alttaki 3 madde de saklıdır:
...
yapay zekanın daha yoğun kullanımına yol açtı. Aslında yeni bir yapay zeka baharını yaşıyoruz. Yapay zeka, bu yüzyılın en önemli teknolojilerinden biri olarak anılıyor. İş hayatının en çok konuşulan konulardan biri olarak kamusal tartışmalara da konu olmuş durumda (özellikle güvenlik ve mahremiyet ile alakalı konularda). Belki de 3. defa AI baharı "AI Spring" yaşanıyor. Daha önce 1960 ve 1980'ler de benzer şekilde Yapay Zeka ve Makine Öğrenmesi çok popüler olmuş, devlet kurumları, üniversiteler ve şirketler ciddi yatırımlar yapmışlar. Fakat beklentiler karşılanamadığı için devamında 1970 ve 1990'lar da araştırma projeleri ya askıya alınmış yada bütçeler kısılmış. Bu dönemler de AI kışı "AI winter" olarak isimlendirilmiştir.
